...
function finishedTest (parsedTest, cb) {
  var output = {
    ...
    ttfb: ((parsedTest.median.firstView.TTFB / 1000) % 60) + '' || 'Unavailable',
    render: ((parsedTest.median.firstView.render / 1000) % 60) + '' || 'Unavailable',
    dom: ((parsedTest.median.firstView.docTime / 1000) % 60) + '' || 'Unavailable',
    domCount: parsedTest.median.firstView.domElements + '' || 'Unavailable',
    loaded: ((parsedTest.median.firstView.fullyLoaded / 1000) % 60) + '' || 'Unavailable',
    size: (parsedTest.median.firstView.bytesIn / 1000) + '' || 'Unavailable',
    requests: parsedTest.median.firstView.requestsFull + '' || 'Unavailable',
